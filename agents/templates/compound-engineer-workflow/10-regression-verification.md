...
Only after semantic verification passes, acquire the
...
full semantic verification before dispatching the gate against the new exact
head; do not reuse the earlier result.
