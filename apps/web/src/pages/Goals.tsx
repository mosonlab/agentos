...
/* No spend is rendered on either surface. `Goal.spendUsd` has one writer in the
 * whole system — the column default of 0 — so a spend figure here would read as
 * "this goal has cost nothing" when what it means is "nothing measures goal
 * spend yet". The cap the operator types is still stored; it is configuration
 * for an execution model that is not wired (README, Feature surface). */
