...
const boardTask = (overrides: Partial<BoardTask> = {}): BoardTask => ({
  ...
  latestRun: { id: "run-1", runNumber: 1, status: "SUCCEEDED", model: "claude-opus-5:medium", codexServiceTier: "DEFAULT", costUsd: null, startedAt: null, endedAt: null, pullRequestUrl: null }, strandedSalvageBranches: [], taskCost: null,
