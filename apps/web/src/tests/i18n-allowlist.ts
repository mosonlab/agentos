...
export const I18N_ALLOWLIST: I18nAllowlistEntry[] = [
  ...
  { file: "pages/Triggers.tsx", text: "X-Anneal-Webhook-Secret", why: "HTTP header identifier" },
  { file: "pages/Triggers.tsx", text: "X-Anneal-Delivery-Id", why: "HTTP header identifier" },
