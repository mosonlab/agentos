...
Chain config: ⑤ `implementation-plan-executioner`, ⑥ `review-coordinator`, ⑦ `senior-dev`. Model, runner, and reasoning tier come from each agent's current configuration; task prompts stay model-neutral.
