...
classification: macOS on Apple Silicon is still the only target, the clean
fresh-install gate is still open, and the merge-executor and gate-worker
profiles are documented rather than verified. The
