...
| Repository command-line interface | **Not shipped in the current release** | The help-only v0.1.0 interface was retired in v0.2.0 rather than carried forward without operational command families. |
