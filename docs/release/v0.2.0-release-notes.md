...
- **Operations.** A canonical-prompt sync command for existing installations, a
  ...
  published operational harnesses. The help-only repository command-line
  interface is retired and no `agentos` binary is shipped.
...
The [v0.1.0 support matrix](v0.1.0-support-matrix.md) remains the current
...
[security](v0.1.0-security.md),
[license and assets](v0.1.0-license-and-assets.md) and
[migration and recovery](v0.1.0-migration-and-recovery.md) documents remain
current.
