  ...
  const completed = await call("POST", `/runner/runs/${run.id}/complete`, RUNNER, {
    ...
    outcome: {
      ...
      envelope: {
        ...
        terminationReason: null, terminalEventSeen: false, terminalSuccess: false, agentExited: true,
        providerError: null, stderrSummary: "session ended without a result", stdoutSummary: null,
